...
import { useManuals, useCreateManual } from "@/hooks/useManual";
...
export default function ClientDetailPage({ params }: PageProps) {
  ...
  const { mutate: createManual, isPending: isCreating } = useCreateManual();
                ...
                return (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-xs text-gray-400">v{m.version} · {formatDate(m.updatedAt)}</p>
                    </div>
